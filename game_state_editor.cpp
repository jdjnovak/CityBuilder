    ...
    while(this->game->window.pollEvent(event)) {
        switch(event.type) {
            case sf::Event::MouseMoved: {
		    	...
		    	} else if(actionState == ActionState::SELECTING) { // Select tiles
		    ...
		    case sf::Event::MouseButtonPressed: {
		    	if(event.mouseButton.button == sf::Mouse::Middle) { // Start panning
		    		if(this->actionState != ActionState::PANNING) {
		    			this->actionState = ActionState::PANNING;
		    			this->panningAnchor = sf::Mouse::getPosition(this->game->window);
		    		}
		    	} else if(event.mouseButton.button == sf::Mouse::Left) {
		    		if(this->actionState != ActionState::SELECTING) { // Select tile
		    		...
		    		if(this->actionState == ActionState::SELECTING) { // Stop select
		    ...
		    case sf::Event::MouseButtonReleased: {
		    	if(event.mouseButton.button == sf::Mouse::Middle) { // Stop panning
		    		this->actionState = ActionState::NONE;
		    	} else if(event.mouseButton.button == sf::Mouse::Left) { // Stop selecting
		    ...
		    case sf::Event::MouseWheelMoved: { // Zoom view
